...
namespace DelayedImagesEF.Web {
    ...
    public partial class DelayedImagesEFAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private DelayedImagesEF.Module.DelayedImagesEFModule module3;
        private DelayedImagesEF.Module.Web.DelayedImagesEFAspNetModule module4;

        public DelayedImagesEFAspNetApplication() {
            InitializeComponent();
        }
        ...
        private void DelayedImagesEFAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module4 = new DelayedImagesEF.Module.Web.DelayedImagesEFAspNetModule();
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.DelayedImagesEFAspNetApplication_DatabaseVersionMismatch);
